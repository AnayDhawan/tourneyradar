      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
            ...
            <Link href="/docs" style={{ color: "var(--text-secondary)", textDecoration: "none", fontSize: "0.875rem" }}>
              Docs
            </Link>
            <Link href="/updates" style={{ color: "var(--text-secondary)", textDecoration: "none", fontSize: "0.875rem" }}>
              Updates
            </Link>
            <Link href="/about" style={{ color: "var(--text-secondary)", textDecoration: "none", fontSize: "0.875rem" }}>
              About
            </Link>
            <Link href="/support" style={{ color: "var(--text-secondary)", textDecoration: "none", fontSize: "0.875rem" }}>
              Support Us
            </Link>
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
            ...
            <Link href="/stats" style={{ color: "var(--text-secondary)", textDecoration: "none", fontSize: "0.875rem" }}>
              Site Analytics
            </Link>
          </div>
        </div>
